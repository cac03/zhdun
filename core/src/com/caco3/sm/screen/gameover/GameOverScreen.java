...
public class GameOverScreen implements SmScreen {
    ...
    public void renderInto(SpriteBatch spriteBatch) {
        ...
        spriteBatch.draw(zhdun, (float) Gdx.graphics.getWidth() / 2.0F - (float) zhdun.getWidth() / 2.0F, (float) Gdx.graphics.getHeight() / 2.0F - (float) zhdun.getHeight() / 2.0F);
        font.draw(spriteBatch, "Game over. Your score: " + count, (float) Gdx.graphics.getWidth() / 2.0F - 100, 50);
